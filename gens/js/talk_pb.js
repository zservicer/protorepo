...
goog.exportSymbol('proto.SetPermissionsRequest', null, global);
...
proto.ProfileResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.ProfileResponse.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.SetPermissionsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SetPermissionsRequest.repeatedFields_, null);
};
goog.inherits(proto.SetPermissionsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.SetPermissionsRequest.displayName = 'proto.SetPermissionsRequest';
}
 ...
 * @const
 */
proto.LoginResponse.repeatedFields_ = [4,5];
...
proto.LoginResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    userId: jspb.Message.getFieldWithDefault(msg, 2, ""),
    userName: jspb.Message.getFieldWithDefault(msg, 3, ""),
    actIdsList: (f = jspb.Message.getRepeatedField(msg, 4)) == null ? undefined : f,
    bizIdsList: (f = jspb.Message.getRepeatedField(msg, 5)) == null ? undefined : f
  };
...
proto.ProfileRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    renewToken: jspb.Message.getBooleanFieldWithDefault(msg, 1, false)
  };
...
/**
 * optional bool renew_token = 1;
 * @return {boolean}
 */
proto.ProfileRequest.prototype.getRenewToken = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};
 ...
 */
proto.ProfileRequest.prototype.setRenewToken = function(value) {
  return jspb.Message.setProto3BooleanField(this, 1, value);
};
 ...
 * @const
 */
proto.ProfileResponse.repeatedFields_ = [4,5];
 ...
 * @return {string}
 */
proto.ProfileResponse.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.ProfileResponse.prototype.setToken = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.ProfileResponse.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Array<string>}
 */
proto.ProfileResponse.prototype.getActIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 4));
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.setActIdsList = function(value) {
  return jspb.Message.setField(this, 4, value || []);
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.addActIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 4, value, opt_index);
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.clearActIdsList = function() {
  return this.setActIdsList([]);
};
 ...
 * @return {!Array<string>}
 */
proto.ProfileResponse.prototype.getBizIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 5));
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.setBizIdsList = function(value) {
  return jspb.Message.setField(this, 5, value || []);
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.addBizIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 5, value, opt_index);
};
 ...
 * @return {!proto.ProfileResponse} returns this
 */
proto.ProfileResponse.prototype.clearBizIdsList = function() {
  return this.setBizIdsList([]);
};
 ...
 * @const
 */
proto.SetPermissionsRequest.repeatedFields_ = [3,4];
 ...
 * @return {!Object}
 */
proto.SetPermissionsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.SetPermissionsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SetPermissionsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SetPermissionsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    token: jspb.Message.getFieldWithDefault(msg, 1, ""),
    userId: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SetPermissionsRequest}
 */
proto.SetPermissionsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SetPermissionsRequest;
  return proto.SetPermissionsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SetPermissionsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SetPermissionsRequest}
 */
proto.SetPermissionsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SetPermissionsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SetPermissionsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SetPermissionsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SetPermissionsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getToken();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.SetPermissionsRequest.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.setToken = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.SetPermissionsRequest.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Array<string>}
 */
proto.SetPermissionsRequest.prototype.getActIdsList = function() {
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.setActIdsList = function(value) {
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.addActIds = function(value, opt_index) {
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.clearActIdsList = function() {
  return this.setActIdsList([]);
};
 ...
 * @return {!Array<string>}
 */
proto.SetPermissionsRequest.prototype.getBizIdsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 4));
};
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.setBizIdsList = function(value) {
  return jspb.Message.setField(this, 4, value || []);
};
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.addBizIds = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 4, value, opt_index);
};
 ...
 * @return {!proto.SetPermissionsRequest} returns this
 */
proto.SetPermissionsRequest.prototype.clearBizIdsList = function() {
  return this.setBizIdsList([]);
};
